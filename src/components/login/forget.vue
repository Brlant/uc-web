    ...
    <el-card class="box-card main-card-box">
      ...
      <div class="form-part">
        <div v-if="showInfo" class="text-center">
          ...
          <el-button type="danger" class="primary" @click="resend" style="display:block;width:100%;margin:30px 0">
            没有收到？点击重新发送验证邮件
          </el-button>
        </div>
        <div v-else-if="showPhoneCode">
          ...
          <el-form key="el-form--reset" label-position="top" ref="resetForm" label-width="80px" :model="resetUser"
            ...
            <el-button-group style="width: 100%">
              ...
              <el-button plain style="width:50%;" @click="$router.push('/login')">
                返回登录
              </el-button>
            </el-button-group>
          </el-form>
        ...
        <div v-else>
          ...
          <el-form key="el-form--login" label-position="top" ref="loginForm" label-width="80px" :model="user"
            ...
            <el-form-item label="业务单位编号" prop="orgCode">
  ...
  export default {
    ...
    data: function () {
      ...
      return {
        ...
        rules: {
          orgCode: [
            {required: true, message: '请输入业务单位编号', trigger: 'blur'}
          ],
          account: [
